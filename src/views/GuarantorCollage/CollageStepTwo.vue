<template>
      <div class="q-pa-md">
         <div class="q-gutter-lg">
            <p class="title_color">Relationship with Applicant</p>
            <div class="q-mb-lg">
               <div class="q-mt-sm q-ml-sm">
                    <div>
                        <q-radio dense v-model="relationship_applicant" val="Parent" label="Parent" style="width: 60%;" />
                        <q-radio dense v-model="relationship_applicant" val="Friend" label="Friend" />
                    </div>
                    <div class="q-mt-md">
                        <q-radio dense v-model="relationship_applicant" val="Spouse" label="Spouse" style="width: 60%;" />
                        <q-radio dense v-model="relationship_applicant" val="Alone" label="Alone" />
                    </div>
                    <div class="q-mt-md">
                        <q-radio dense v-model="relationship_applicant" val="Relative" label="Relative" />
                    </div>
               </div>
            </div>
            <p class="title_color">Guarantor's Address Informations</p>
            <div>
            ...
            <div class="q-mb-xl">
               ...
               <div class="q-mt-md">
                    <div>
                        <q-radio dense v-model="residence_type" val="Owner" label="Owner" style="width: 60%;" />
                        <q-radio dense v-model="residence_type" val="Rental" label="Rental" />
                    </div>
                    <div class="q-mt-md">
                        <q-radio dense v-model="residence_type" val="Parental" label="Parental" style="width: 60%;" />
                        <q-radio dense v-model="residence_type" val="Hostel" label="Hostel" />
                    </div>
               </div>
            </div>
            <div class="q-mb-xl">
               ...
               <div class="q-mt-md">
                    <div>
                        <q-radio dense v-model="living_with" val="Parent" label="Parent" style="width: 60%;" />
                        <q-radio dense v-model="living_with" val="Friend" label="Friend" />
                    </div>
                    <div class="q-mt-md">
                        <q-radio dense v-model="living_with" val="Spouse" label="Spouse" style="width: 60%;" />
                        <q-radio dense v-model="living_with" val="Alone" label="Alone" />
                    </div>
                    <div class="q-mt-md">
                        <q-radio dense v-model="living_with" val="Relative" label="Relative" />
                    </div>
               </div>
            </div>
