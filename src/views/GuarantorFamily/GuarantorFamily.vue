...
import FamilyStepOne from "./FamilyStepOne.vue"
import FamilyStepTwo from "./FamilyStepTwo.vue"
import FamilyStepThree from "./FamilyStepThree.vue"
import FamilyStepFour from "./FamilyStepFour.vue"
export default {
  components: {
    CommonHeader,
    FamilyStepOne,
