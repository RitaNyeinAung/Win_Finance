         ...
         <div class="q-gutter-lg">
            ...
            <div class="q-mb-xl q-mt-xl">
               ...
               <div class="q-mt-md">
                    ...
                    <q-input 
                        outlined 
                        v-model="family_step_two.ward_village_input" 
                    ...
                    <q-input 
                        outlined 
                        v-model="family_step_two.street_address" 
                        @change="countValue($event)"
                    ...
                    <q-input 
                        outlined 
                        v-model="family_step_two.building_no" 
                        @change="countValue($event)"
               ...
               <div class="q-mt-md">
                    ...
                    <div style="display: flex">
                        <q-input 
                            outlined 
                            class="q-mr-sm" 
                            v-model="family_step_two.years_stay" 
                            @change="countValue($event)"
                            placeholder="..." 
                            style="width: 50%;" 
                        ...
                        <q-input 
                            outlined 
                            v-model="family_step_two.months_stay" 
                            @change="countValue($event)"
                            placeholder="..." 
                            style="width: 50%;" 
