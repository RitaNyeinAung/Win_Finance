      ...
      <template v-slot:navigation>
        <q-stepper-navigation>
          <div class="button_group text-center q-mt-md">
            <q-btn v-if="step != 2" @click="$refs.stepper.previous()" class="button_color" text-color="black" label="Back" no-caps />
            <q-btn v-if="step != 2" @click="$refs.stepper.next()" class="button_color" text-color="black" label="Next" no-caps />
